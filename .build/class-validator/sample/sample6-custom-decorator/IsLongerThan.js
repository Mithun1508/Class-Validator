...
var IsLongerThan_exports = {};
__export(IsLongerThan_exports, {
  IsLongerThan: () => IsLongerThan,
  IsLongerThanConstraint: () => IsLongerThanConstraint
});
module.exports = __toCommonJS(IsLongerThan_exports);
...
let IsLongerThanConstraint = class {
  validate(value, args) {
...
IsLongerThanConstraint = __decorateClass([
  (0, import_decorators.ValidatorConstraint)({ name: "isLongerThan" })
...
//# sourceMappingURL=IsLongerThan.js.map
