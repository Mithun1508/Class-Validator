...
var IsUUID_exports = {};
__export(IsUUID_exports, {
  IS_UUID: () => IS_UUID,
  IsUUID: () => IsUUID,
  isUUID: () => isUUID
});
module.exports = __toCommonJS(IsUUID_exports);
var import_ValidateBy = require("../common/ValidateBy");
var import_isUUID = __toESM(require("validator/lib/isUUID"));
  ...
  return (0, import_ValidateBy.ValidateBy)(
    {
      ...
      validator: {
        ...
        defaultMessage: (0, import_ValidateBy.buildMessage)((eachPrefix) => eachPrefix + "$property must be a UUID", validationOptions)
      }
    },
    validationOptions
  );
