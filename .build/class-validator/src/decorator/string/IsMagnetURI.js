...
var IsMagnetURI_exports = {};
__export(IsMagnetURI_exports, {
  IS_MAGNET_URI: () => IS_MAGNET_URI,
  IsMagnetURI: () => IsMagnetURI,
  isMagnetURI: () => isMagnetURI
});
module.exports = __toCommonJS(IsMagnetURI_exports);
var import_ValidateBy = require("../common/ValidateBy");
var import_isMagnetURI = __toESM(require("validator/lib/isMagnetURI"));
