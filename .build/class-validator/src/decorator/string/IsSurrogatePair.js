...
var IsSurrogatePair_exports = {};
__export(IsSurrogatePair_exports, {
  IS_SURROGATE_PAIR: () => IS_SURROGATE_PAIR,
  IsSurrogatePair: () => IsSurrogatePair,
  isSurrogatePair: () => isSurrogatePair
});
module.exports = __toCommonJS(IsSurrogatePair_exports);
var import_ValidateBy = require("../common/ValidateBy");
var import_isSurrogatePair = __toESM(require("validator/lib/isSurrogatePair"));
