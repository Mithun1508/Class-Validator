...
var IsMimeType_exports = {};
__export(IsMimeType_exports, {
  IS_MIME_TYPE: () => IS_MIME_TYPE,
  IsMimeType: () => IsMimeType,
  isMimeType: () => isMimeType
});
module.exports = __toCommonJS(IsMimeType_exports);
var import_ValidateBy = require("../common/ValidateBy");
var import_isMimeType = __toESM(require("validator/lib/isMimeType"));
