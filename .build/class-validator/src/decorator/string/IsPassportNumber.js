...
var IsPassportNumber_exports = {};
__export(IsPassportNumber_exports, {
  IS_PASSPORT_NUMBER: () => IS_PASSPORT_NUMBER,
  IsPassportNumber: () => IsPassportNumber,
  isPassportNumber: () => isPassportNumber
});
module.exports = __toCommonJS(IsPassportNumber_exports);
var import_ValidateBy = require("../common/ValidateBy");
var import_isPassportNumber = __toESM(require("validator/lib/isPassportNumber"));
