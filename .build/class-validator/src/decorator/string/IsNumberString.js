...
var IsNumberString_exports = {};
__export(IsNumberString_exports, {
  IS_NUMBER_STRING: () => IS_NUMBER_STRING,
  IsNumberString: () => IsNumberString,
  isNumberString: () => isNumberString
});
module.exports = __toCommonJS(IsNumberString_exports);
var import_ValidateBy = require("../common/ValidateBy");
var import_isNumeric = __toESM(require("validator/lib/isNumeric"));
  ...
  return (0, import_ValidateBy.ValidateBy)(
    {
      ...
      validator: {
        ...
        defaultMessage: (0, import_ValidateBy.buildMessage)((eachPrefix) => eachPrefix + "$property must be a number string", validationOptions)
      }
    },
    validationOptions
  );
